...
import Rankings from "../../features/rankings/Rankings/Rankings";
...
import { useCreateNewCustomRankingsMutation } from "../../features/customRankings/customRankingsApiSlice";
...
const RankingsPage = () => {
  ...
  useEffect(() => {
    setSelectedTemplate(
      rankingsTemplates &&
        rankingsTemplates.length > 0 &&
        rankingsTemplates[0]._id
    );
  }, [rankingsTemplates]);
  ...
  const filterPlayers = (players) => {
    ...
    temp = players.filter((player) => player?.position === selectedPosition);
    return temp;
  };
  ...
  const customizeRanking = () => {
    ...
    createNewCustomRankings({
      ...
      .unwrap()
      .then((fulfilled) => navigate(`/custom/${fulfilled._id}`))
  ...
  return (
    <div className="rankings-page">
      <Helmet>
        ...
        <meta
          name="description"
          content="Customize your own FREE fantasy football draft rankings with Draftabl's 
      ...
      <main>
        ...
        <p className="description">
          Our rankings are an index of expert consensus rankings across the
          industry and are updated daily. <br /> Select Customize to edit these
          rankings.
        </p>
        <div className="options-wrapper">
          <div className="options-row">
            ...
            <button className="edit-button" onClick={customizeRanking}>
